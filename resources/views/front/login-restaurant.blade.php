...
@section('title','Login Restaurant')
    ...
    <div class="container">
        <section class=" register-page py-5 my-5">
            <div class="reg mx-auto my-5">
                ...
                <form action="{{ route('do.login.restaurant') }}" method="post" class="p-5 my-3 text-center">
                    @csrf
                    ...
                    <div class="form-row my-3">
                        <div class="col new-user">
                            <a href="{{ route('show.register.restaurant') }}">مستخدم جديد ؟</a>
                        </div>
                        <div class="col pass">
                            <a href="{{ route('show.password.restaurant') }}">نسيت كلمة السر ؟</a>
                        </div>
                    </div>
